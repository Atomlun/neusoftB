...
public class UserDaoImpl extends BaseDao implements UserDao{
	...
	public Userinfo login(User user) throws Exception {
		String sql = "select a.uid,uname,b.sex,b.birthday,address,email,ualevel from tb_user a left join tb_userinfo b on a.uid=b.uid where username=? and password = ?";
